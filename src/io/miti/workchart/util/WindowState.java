...
public final class WindowState
{
  ...
  public void saveToFile(final String filename)
  {
    ...
    saveStringProp(prop, "environment", environment);
    saveStringProp(prop, "schema", schema);
  ...
  private void saveStringProp(final Properties prop,
                              final String key,
                              final String value)
  {
    if (value != null)
  ...
  public static void load(final String filename)
  {
    ...
    val = props.getProperty("environment");
    if ((val != null) && (val.length() > 0))
    {
      ws.environment = val.trim();
    }
    
    val = props.getProperty("schema");
    if ((val != null) && (val.length() > 0))
    {
      ws.schema = val.trim();
    }
